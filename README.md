# 🔐 thermocrypt-lite - Secure Your Text with Confidence

## 🚀 Getting Started

Welcome to thermocrypt-lite! This application helps you safely encrypt your messages using advanced algorithms. With features inspired by PGP and the benefits of post-quantum cryptography, you can communicate securely in today's digital world.
...
Before installing thermocrypt-lite, ensure your computer meets the following requirements:
...
- **Hybrid Crypto**: Combines the security of Kyber and the speed of X25519 for robust encryption.
- **TPM Hardware Binding**: Uses Trusted Platform Module for enhanced security, binding encryption to specific hardware.
- **Paranoid Memory Hygiene**: Ensures that sensitive data is securely wiped from memory after use.
- **User-Friendly Interface**: Designed for simplicity, making it easy to encrypt and decrypt text.
...
1. Click on the release file that matches your operating system.
...
Using thermocrypt-lite is straightforward. Follow these steps to encrypt text:

1. **Open thermocrypt-lite**: Locate the application icon on your desktop or in your applications folder.
2. **Enter Your Text**: In the main window, type or paste the text you wish to encrypt.
3. **Encrypt**: Click the "Encrypt" button. A secure encrypted version will appear.
4. **Decryption**: To decrypt, paste the encrypted text back into the application and click "Decrypt". Your original message will show up again.

## 🛡️ Security Best Practices

To ensure the safety of your encrypted messages, keep these tips in mind:
...
If you encounter issues while using thermocrypt-lite:
